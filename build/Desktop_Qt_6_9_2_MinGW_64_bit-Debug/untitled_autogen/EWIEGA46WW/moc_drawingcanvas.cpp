...
template <> constexpr inline auto DrawingCanvas::qt_create_metaobjectdata<qt_meta_tag_ZN13DrawingCanvasE_t>()
{
    ...
    QtMocHelpers::StringRefStorage qt_stringData {
        "DrawingCanvas",
        "calculateAndDrawConvexHull",
        "",
        "calculateAndDrawSlowConvexHull",
        "clearCanvas"
    };

    QtMocHelpers::UintData qt_methods {
        // Slot 'calculateAndDrawConvexHull'
        QtMocHelpers::SlotData<void()>(1, 2, QMC::AccessPublic, QMetaType::Void),
        // Slot 'calculateAndDrawSlowConvexHull'
...
void DrawingCanvas::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->calculateAndDrawConvexHull(); break;
        case 1: _t->calculateAndDrawSlowConvexHull(); break;
